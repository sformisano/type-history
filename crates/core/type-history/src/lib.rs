...
//! through that alias.
//!
//! After [setting up a library package](https://github.com/sformisano/type-history/blob/v0.2.0/book/src/setup.md),
...
//! [distributed-system walkthrough](https://github.com/sformisano/type-history/blob/v0.2.0/README.md#using-type-history-in-a-distributed-system).
//!
//! Install the matching 0.2.0 crates from crates.io. The [package setup guide](https://github.com/sformisano/type-history/blob/v0.2.0/book/src/setup.md)
...
//! The [book](https://github.com/sformisano/type-history/blob/v0.2.0/book/README.md)
...
//! stored profiles. See the [field integration guide](https://github.com/sformisano/type-history/blob/v0.2.0/book/src/integration.md).
